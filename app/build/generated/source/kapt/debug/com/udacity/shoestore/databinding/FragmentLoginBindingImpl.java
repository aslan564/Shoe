...
public class FragmentLoginBindingImpl extends FragmentLoginBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.email_text_field, 3);
        sViewsWithIds.put(R.id.password_input_field, 4);
        sViewsWithIds.put(R.id.login_button, 5);
        sViewsWithIds.put(R.id.text_view_no_account, 6);
    }
    // views
    @NonNull
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, userUserEmail);
